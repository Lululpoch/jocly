class LegacyJSONLoader extends THREE.Loader {
	...
	parse(json, path) {
		...
		// #UPGARDEISSUE the initMaterials function does not exist anymore, need to redefine it as a local function with code from r99
